...
var Primitives = {
    ...
    //This version, modified by Don Rowe, takes a dash parameter which draws
    //the given number of pixels, skips a pixel, and repeats.
    lineBresenham: function (context, x1, y1, x2, y2, color, dash) {
        var x = x1,
            ...
            err = k1 - dx,
            count = 0, //The number of pixels that have been drawn
     ...
     * 
     * Modded by Don Rowe to fill in the circle instead of just tracing it.
     */
